...
qq.FineUploaderBasic.prototype = {
    ...
    _onSubmitCallbackSuccess: function(id, name) {
        ...
        //GW - moved onSubmitted callback intot he if\else block as for items not auto uploaded we need to store for later first.
        if (this._options.autoUpload) {
...
qq.DragAndDrop = function(o) {
    ...
    function setupDropzone(dropArea){
        dz = new qq.UploadDropZone({
            ...
            onDrop: function(e){
                //GW - set the drop Area so we can access it later
                qq.dropArea = dropArea;
